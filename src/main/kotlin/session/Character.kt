...
object Character {
    ...
    fun getCharacterPortrait(byte: Byte): Rectangle2D {
        when (byte) {
            ...
            MA -> return Rectangle2D(128.0, 0.0, 64.0, 64.0)
            MI -> return Rectangle2D(192.0, 0.0, 64.0, 64.0)
            ZA -> return Rectangle2D(256.0, 0.0, 64.0, 64.0)
            PO -> return Rectangle2D(320.0, 0.0, 64.0, 64.0)
            CH -> return Rectangle2D(384.0, 0.0, 64.0, 64.0)
            FA -> return Rectangle2D(448.0, 0.0, 64.0, 64.0)
            AX -> return Rectangle2D(0.0, 64.0, 64.0, 64.0)
            VE -> return Rectangle2D(64.0, 64.0, 64.0, 64.0)
            SL -> return Rectangle2D(128.0, 64.0, 64.0, 64.0)
            IN -> return Rectangle2D(192.0, 64.0, 64.0, 64.0)
            BE -> return Rectangle2D(256.0, 64.0, 64.0, 64.0)
            RA -> return Rectangle2D(320.0, 64.0, 64.0, 64.0)
            SI -> return Rectangle2D(384.0, 64.0, 64.0, 64.0)
            EL -> return Rectangle2D(448.0, 64.0, 64.0, 64.0)
            LE -> return Rectangle2D(0.0, 128.0, 64.0, 64.0)
            JO -> return Rectangle2D(64.0, 128.0, 64.0, 64.0)
            JC -> return Rectangle2D(128.0, 128.0, 64.0, 64.0)
            JM -> return Rectangle2D(192.0, 128.0, 64.0, 64.0)
            KU -> return Rectangle2D(256.0, 128.0, 64.0, 64.0)
            RV -> return Rectangle2D(320.0, 128.0, 64.0, 64.0)
            DI -> return Rectangle2D(384.0, 128.0, 64.0, 64.0)
            BA -> return Rectangle2D(448.0, 128.0, 64.0, 64.0)
            AN -> return Rectangle2D(0.0, 192.0, 64.0, 64.0)
            else -> return Rectangle2D(64.0, 192.0, 64.0, 64.0)
        }
    }
